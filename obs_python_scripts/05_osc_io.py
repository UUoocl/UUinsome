...
# ------------------------------------------------------------
# region Signal Connection Logic
# ------------------------------------------------------------
...
def on_frontend_event(event):
    ...
    if event == obs.OBS_FRONTEND_EVENT_FINISHED_LOADING:
        print("OBS OSC Finished Loading. Connecting...")
        
        if setup_signal_handler():
            print("OSC Connected successfully.")
        else:
            print(f"OSC Warning: Source not found.")
...
def script_load(settings):
    ...
    if not success:
        print("Source not ready. Waiting for OBS load event...")
